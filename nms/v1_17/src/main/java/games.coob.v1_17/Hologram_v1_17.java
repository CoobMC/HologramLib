 ...
 */
public class Hologram_v1_17 extends Hologram {
    ...
    private void sendPackets(final ArmorStand armorStand, final Player player) {
        ...
        Remain.sendPacket(player, new ClientboundSetEntityDataPacket(armorStand.getId(), armorStand.getEntityData(), true));
    }
