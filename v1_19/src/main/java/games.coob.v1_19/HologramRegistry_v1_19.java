 ...
 */
public final class HologramRegistry_v1_19 extends YamlConfig implements HologramRegistryI {

	/**
	 * The singleton of this class
	 */
	@Getter
	private static final HologramRegistry_v1_19 instance = new HologramRegistry_v1_19();
	 ...
	 */
	private HologramRegistry_v1_19() {
	...
	public List<NMSHologramI> loadHolograms() {
		...
		for (final SerializedMap map : getMapList("Saved_Holograms")) {
			final NMSHologramI hologram = NMSHologram_v1_19.deserialize(map);
